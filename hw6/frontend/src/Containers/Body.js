...
const Body = () => {
    ...
    const handleQuery = async () => {
        const {
            ...
            params: {
                type: queryType,
                queryString, // { type: 'name', queryString: 'Alice' }
            },
        });
    ...
    return (
        <Wrapper>
            <Row>
                ...
                <Button className={classes.button} variant="contained" color="primary" disabled={!name || !subject} onClick={handleAdd}>
                    Add
                </Button>
            </Row>
            <Row>
                ...
                <Button className={classes.button} variant="contained" color="primary" disabled={!queryString} onClick={handleQuery}>
                    Query
                </Button>
            </Row>
